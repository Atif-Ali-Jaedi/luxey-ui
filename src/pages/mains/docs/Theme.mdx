...
> **Note**: See the <ELink link="https://nextui.org/docs/customization/colors" text="Colors"/> page on NextUI to learn more about the colors.
...
<CompsLinks next={{link: "../dark-mode", text: "Dark Mode" }} />
