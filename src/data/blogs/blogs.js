...
const blogs = [
	{
		...
		description:
			"NextUI v0.3.0 is here! Includes many bug fixes, dark mode, a new component and many more.",
		tag: "Changelog",
	...
	},
	{
		...
		description: "After a lot of time and effort, dark mode is finally here!",
		tag: "Announcement",
