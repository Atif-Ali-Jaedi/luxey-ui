...
const buttonVariants = cva(
	`relative overflow-hidden transition-[border,background,opacity,transform,shadow] duration-300 active:scale-97 inline-flex outline-none items-center justify-center gap-3`,
	{
		variants: {
			size: {
